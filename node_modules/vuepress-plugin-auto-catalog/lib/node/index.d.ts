...
declare const autoCatalogPlugin: ({ component, exclude, frontmatter, getIcon, iconRouteMetaKey, getIndex, indexRouteMetaKey, level, locales, getOrder, orderRouteMetaKey, getTitle, titleRouteMetaKey, }?: AutoCatalogOptions) => PluginFunction;
